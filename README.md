...
- `[rtp_study.md](MediaProtrocl/rtp_study.md)`：RTP 承载层说明
...
5. 再读 `MediaProtrocl/rtp_study.md`、`MediaProtrocl/rtsp_study.md` 和 `MediaProtrocl/gb28181_study.md`，把 RTP 的承载位置看清楚。
